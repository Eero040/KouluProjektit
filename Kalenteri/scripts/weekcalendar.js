...
const calendarDayOfWeekTemplateElement = document.querySelector("[data-template='week-calendar-day-of-week-day']");
const calendarAllDayListTemplateElement = document.querySelector("[data-template='week-calendar-all-day-list-item']");
...
function initDayOfWeek(parent, selectedDate, weekDay) {
  ...
  if (isTheSameDay(weekDay, today())) {
    calendarDayOfWeekButtonElement.classList.add("week-calendar_day-of-week-button-highlight");
  }
...
function initAllDayListItem(parent, events) {
  const calendarAllDayListItemContent = calendarAllDayListTemplateElement.content.cloneNode(true);
